	...
	<div class="container-fluid">
		<article class="row justify-content-around mt-3">
			...
			<form class="card card-cadastro col-4" action="" method="POST" enctype="multipart/form-data">
				<h5 class="text-center font-weight-bold font-italic mt-1" for="">Cadastro de usuários</h5>
				...
				<div class="input-group mt-2">
					...
					<input type="email" class="form-control card-input" name="email" id="email" placeholder="E-mail...">
				</div>
				...
				<div class="input-group mt-2">
					...
					<select name="tipo" class="form-control">
						<option disabled selected>Selecione tipo de usuário...</option>
				...
				<div class="input-group my-2">
					...
					<input type="password" class="form-control card-input" name="senha" id="senha" placeholder="Senha...">
				</div>
